...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (i1, i2) -> Integer.compare(i1, i2) * -1;
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((c1, c2) -> Integer.compare(c2.getBudget(), c1.getBudget())).limit(3).map(Customer::getName);
